...
<section class="project px-3 py-5 p-md-5">
    <div class="container">
        <div class="project-meta media flex-column flex-md-row p-4 theme-bg-light">
            <img class="project-thumb mb-3 mb-md-0 mr-md-5 rounded d-none d-md-inline-block" src="devcard/assets/images/project/project-3.jpg" alt="">
            ...
            <div class="project-section mb-5">
                ...
                <div class="row mt-5">
                    <div class="col-12 col-lg-6 mb-5">
                        <img class="img-fluid rounded" src="devcard/assets/images/project/project-figure-1.jpg" alt="image">
                    </div>
                    <div class="col-12 col-lg-6 mb-5">
                        <img class="img-fluid rounded" src="devcard/assets/images/project/project-figure-2.jpg" alt="image">
                    </div>
                </div>
